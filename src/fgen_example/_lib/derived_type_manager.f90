!
! Manager for the lifecycle of the DerivedType calculator
!
...
module mod_derived_type_manager
   ...
   type(DerivedType), target, dimension(N_MODELS) :: instance_array
...
contains
   ...
   subroutine get_instance(model_index, instance)
      ...
      type(DerivedType), pointer, intent(inout) :: instance
...
end module mod_derived_type_manager
